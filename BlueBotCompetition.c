...
#pragma config(Sensor, dgtl2,  armUpLimit,     sensorDigitalIn)
#pragma config(Sensor, dgtl3,  armDownLimit,   sensorDigitalIn)
#pragma config(Sensor, dgtl4,  turnTableReader, sensorQuadEncoder)
#pragma config(Sensor, dgtl8,  LeftDriver,     sensorQuadEncoder)
#pragma config(Sensor, dgtl10, RightDriver,    sensorQuadEncoder)
#pragma config(Motor,  port2,           leftDrive,     tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port3,           turnTableSpinner, tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port4,           mobileArm,     tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port6,           rightDrive,    tmotorVex393_MC29, openLoop, reversed)
#pragma config(Motor,  port8,           clawGrabber,   tmotorVex393_MC29, openLoop)
